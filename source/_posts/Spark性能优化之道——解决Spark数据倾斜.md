---
title: Spark性能优化之道——解决Spark数据倾斜
date: 2018-12-10 21:10:31
tags:
    - spark
    - 大数据
    - 数据倾斜
...
{% asset_img uncompressedfiles.png %}

之后将8.5GB大小的文件使用gzip压缩，压缩后大小仅为25.3MB。

{% asset_img compressedfiles.png %}
...
{% asset_img splitable_unskewed.png %}
...
{% asset_img compressedfileskew.png %}
...
{% asset_img unsplitable_skew.png %}
...
{% asset_img changeparallelism.png %}
...
```bash
spark-submit --queue ambari --num-executors 4 --executor-cores 12 --executor-memory 12g --class com.example.spark.driver.SparkDataSkew --master yarn --deploy-mode client SparkExample-with-dependencies-1.0.jar
```
...
{% asset_img differentkeyskew12.png %}
...
{% asset_img differentkeyskew48.png %}
...
{% asset_img differentkeyskew11.png %}
...
{% asset_img customizedpartition.png %}
...
{% asset_img reducejoincachedag.png %}

并且数据倾斜仍然存在。如下图所示，最慢的Task耗时为7.1分钟，远高于其它Task的约2秒。

{% asset_img reducejoincachelaststage.png %}
...
{% asset_img fewskewkeyjoinallstage.png %}
...
{% asset_img fewskewkeyjoinlaststage.png %}
...
{% asset_img fewskewkeyrandomjoinallstage.png %}
...
{% asset_img fewskewkeyjoinrandomlaststage.png %}
...
{% asset_img randomprefixandenlargesmalltable.png %}
